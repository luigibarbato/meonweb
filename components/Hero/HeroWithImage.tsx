    ...
    return (
        <div className="flex flex-col md:flex-row justify-center">
            <div className="m-10 avatar self-center">
                <img width={props.isMobile ? "150px" : "300px"} height={props.isMobile ? "150px" : "300px"} className="rounded-lg overflow-hidden object-cover" className={props.isMobile ? "rounded-lg object-cover h-36 w-36" : "rounded-lg object-cover h-[300] w-[350]"} src={props.image} alt="" />
            </div>
